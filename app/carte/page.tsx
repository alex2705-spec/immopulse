    ...
    <div style={{ height: '100dvh', display: 'flex', flexDirection: 'column', fontFamily: 'DM Sans, sans-serif', overflow: 'hidden' }}
      ...
      {isMobile ? (
        <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
          ...
          <div ref={drawerRef} style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: drawerOpen ? '64%' : '0%', background: '#fff', borderRadius: '20px 20px 0 0', boxShadow: '0 -4px 24px rgba(0,0,0,0.12)', transition: 'height 0.3s ease', zIndex: 1000, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
